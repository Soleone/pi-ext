...
- `pi-notify`: Sends `zellij-attention` waiting/completed markers for background-tab attention, plus macOS desktop notifications on completion when available and OSC 777 as a completion fallback.
